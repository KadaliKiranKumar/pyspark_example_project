...
def start_spark(app_name='my_spark_app', master='local[*]', jar_packages=[],
    ...
    # spark_files_dir_tt = SparkFiles.getRootDirectory()
    spark_files_dir = 'D:/Kiran_The_Power_of_Practice3/pyspark_example_project/pyspark-example-project/configs'
    # spark_files_dir = '../configs'
